		...
		<>
			<nav className="w-full bg-slate-100 px-5 shadow-md sticky top-0 z-10">
				<div className="flex flex-row items-center justify-between max-w-7xl mx-auto">
					...
					<div className="flex flex-row items-center gap-2 md:w-full md:max-w-md">
						<form
                            onSubmit={(e) => e.preventDefault() }
							className="border border-gray-200 inset-shadow-sm bg-white rounded-md max-w-56 items-center justify-between hidden md:flex"
						>
							<input
								type="text"
								name=""
                                ...
                                className="w-full px-2 py-2 text-xs text-gray-800 font-regular  outline-none "
