					...
					<div className="flex flex-col gap-4 items-start w-full">
						...
						{selectCard == "Aprendes y ayudamos" && (
							<div className="flex flex-row gap-16 flex-wrap items-center justify-center w-full">
								<div className="flex flex-col gap-6 min-w-2xs">
                                    <div className="flex flex-col gap-2">
                                        ...
                                        <p className="text-sm text-sky-900">
                                            Con cada granito de arena hacemos un mundo mejor
                                        </p>
                                    </div>
                                    <button type="button" className="bg-gray-300 py-3 px-4 text-left text-sm font-semibold text-sky-950 flex flex-row items-center gap-2 rounded-lg cursor-pointer">
                                ...
                                <img src="../src/assets/Ayuda-benefica.png" alt="Foto de ayuda benéfica a diversos lugares." className="max-w-3xl w-full border-8 border-gray-50 shadow-lg" />
							</div>
						)}
					</div>
				)}
