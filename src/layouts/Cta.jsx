    ...
    return (
		<>
			<section className="bg-sky-200 py-20 px-6 w-full">
				<div className="max-w-7xl mx-auto flex flex-row flex-wrap items-center justify-between relative">
			...
			<section className="bg-sky-200 px-6 w-full border-t-2 border-t-gray-50">
				<div className="max-w-7xl mx-auto grid grid-cols-3 justify-start">
                    <article className="py-8 px-8 flex flex-row gap-2">
                    ...
                    <article className="py-8 border-x-2 border-x-gray-50 px-8 flex flex-row gap-2">
